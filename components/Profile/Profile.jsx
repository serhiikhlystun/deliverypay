...
import img_01 from "../WishListItem/img/card-img-01.jpg";
import img_02 from "../WishListItem/img/card-img-02.jpg";
import img_03 from "../WishListItem/img/card-img-03.jpg";
import img_04 from "../WishListItem/img/card-img-04.jpg";
            ...
            <div className="container">
                <div className="profile__wrapp">
                    <h2 className="profile__title">
                        andre@gmail.com
                        <svg onClick={handleOpenPopup} width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="profile__subtitle">
                        Chicago 123, avenue, Room 123
                    </p>
                </div>
                <h2 className="wish-list__title">
                    My WISH LIST
                </h2>
                <div className="wish-list__wrapp">
                    ...
                    <div className="wish-list__more">
                        <button className="wish-list__more-btn">
                            Load more
                        </button>
                    </div>
                </div>
                <div className="order__wrapp">
                    ...
                    <div className="order__more">
                        <button className="order__more-btn">
                            Load more
                        </button>
                    </div>
                </div>
