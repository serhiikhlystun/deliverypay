    ...
    return (
        <section className="categories">
            <div className="container">
                <div className="categories__wrapp">
                    <div className="categories__title-wrapp">
                        <h2 className="categories__title">
                            Products
                        </h2>
                        <svg className="categories__title-arrow" width="6" height="12" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="categories__list">
                        {categories.map((category, index) => (
                            <CategoriesItem
                                ...
                                image={category.category_image.id}
                                id={category.id}
                                slug={category.slug}
                            />
                        ))}
