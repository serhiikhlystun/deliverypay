            ...
            <div className="popup__content">
                ...
                <div className="popup__title-wrapp">
                    ...
                    <p className="popup__subtitle">
                        CHANGE ACCOUNT INFRORMATION
                    </p>
                </div>
                <div className="popup__input-wrapp">
                    <input className="popup__input" type="text" placeholder="ANDRE@GMAIL.COM"/>
                    <input className="popup__input" type="password" placeholder="123456"/>
                    <input className="popup__input" type="number" placeholder="+12025550118"/>
                    <input className="popup__input" type="text" placeholder="Chicago 123, avenue, Room 123 "/>
                    <input className="popup__input" type="text" placeholder="420comrades"/>
                </div>
                <button className="popup__save-btn" onClick={closeSettingsPopup}>SAVE</button>
            </div>
        </div>
    );
};
