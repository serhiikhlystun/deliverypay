...
const GuestCartPopup = ({ isOpen, onClose }) => {
    ...
    <div className={`popup__wrapp ${isOpen ? 'open' : ''}`}>
      ...
      <div className="popup__content">
        ...
        <div className="popup__title-wrapp">
          ...
          <button className="popup__save-btn guest" onClick={closeGuestCartPopup}>
            REGISTER
          </button>
          <button className="popup__save-btn white" onClick={closeGuestCartPopup}>
            LOG IN
          </button>
          </div>
          <button className="popup__save-btn white" onClick={closeGuestCartPopup}>
