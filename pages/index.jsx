...
export default function Home() {
  ...
  const {data: products, isSuccess} = useQuery("products", async () => await getData(SaleProductsQuery, 'products'))
  const {data: categories, isSuccess: categoriesSuccess } = useQuery("categories", async () => await getData(CategoriesQuery, 'categories'))
