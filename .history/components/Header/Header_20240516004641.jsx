...
const Header = () => {
  ...
  // }, [store.tempOrder, localSession, isSuccess]);

  useEffect(() => {
    const calculateItemCount = () => {
      let totalItems = 0;
      if (store.tempOrder) {
        totalItems = store.tempOrder.length;
      }
      if (localSession && localSession.temp_order) {
        totalItems = localSession.temp_order.length;
      }
        ...
        <div className="header__wrapper">
          ...
          <div className="header__right">
            ...
            <div className="header__icon-wrapp">
              ...
              <BusketIcon itemsInCart={prevItemCount} />
            </div>
          </div>
        </div>
        {isPopupOpen && (
