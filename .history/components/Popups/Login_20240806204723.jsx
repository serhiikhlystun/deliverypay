    ...
    <div className={`popup__wrapp ${isOpen ? 'open' : ''}`}>
      ...
      <div className="popup__content">
        ...
        <div className="popup__title-wrapp">
          ...
          <p className="popup__subtitle">You will receive 5% cashback from each purchase</p>
        </div>
        <form className="popup__form" onSubmit={e => handleSubmit(e)}>
          ...
          <button className="popup__save-btn success" type="submit">
            LOGIN
          </button>
         
          <button className="popup__save-btn success" type="button" onClick={requestPasswordOpen}>
