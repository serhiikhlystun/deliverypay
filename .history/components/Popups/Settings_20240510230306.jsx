      ...
      <div className="popup__content">
        ...
        <form onSubmit={handleUpdate}>
          <div className="popup__input-wrapp">
            <input name="email" className="popup__input" type="text" placeholder={user.email??"Email"} />
            <input name="password" className="popup__input" type="password" placeholder="****************" />
            <input name="phone" className="popup__input" type="tel" placeholder={user.phone ? user.phone : 'Enter your phone' } />
            <input name="location" className="popup__input" type="text" placeholder={user.location ? user.location : 'Enter your Address'} />
